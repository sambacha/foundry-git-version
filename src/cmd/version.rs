...
pub(super) fn get_command() -> (&'static str, super::FoundryCommand) {
    (
        "version",
        super::FoundryCommand {
            make,
            run,
...
fn run(matches: &ArgMatches) -> Result<()> {
    ...
    let hash_suffix = option_env!("FOUNDRY_BUILD_GIT_HASH")
    ...
    if matches.contains_id("short") {
        ...
        println!(
            "Foundry {pkg_version}{hash_suffix}\n\
             Copyright (C) 2021-2023 Foundry authors\n\
